 ...
 * @brief 高斯测试套件
 */
INSTANTIATE_TEST_SUITE_P(PerformanceTestsGAUSSIAN, cpuConv2dPerformanceTestFloat, testing::Values(PerformanceTestParams{512, 512, 10, 3, filter_type::GAUSSIAN, mem_type::SHAREDCONST}, PerformanceTestParams{512, 512, 10, 5, filter_type::GAUSSIAN, mem_type::SHAREDCONST}, PerformanceTestParams{1024, 1024, 10, 3, filter_type::GAUSSIAN, mem_type::SHAREDCONST}, PerformanceTestParams{1024, 1024, 10, 5, filter_type::GAUSSIAN, mem_type::SHAREDCONST}));
/**
 * @brief 锐化滤波器测试套件
 */
INSTANTIATE_TEST_SUITE_P(PerformanceTestsSHARPEN, cpuConv2dPerformanceTestFloat, testing::Values(PerformanceTestParams{512, 512, 10, 3, filter_type::SHARPEN, mem_type::SHAREDCONST}, PerformanceTestParams{512, 512, 10, 3, filter_type::SHARPEN, mem_type::SHAREDCONST}, PerformanceTestParams{1024, 1024, 10, 3, filter_type::SHARPEN, mem_type::SHAREDCONST}, PerformanceTestParams{1024, 1024, 10, 3, filter_type::SHARPEN, mem_type::SHAREDCONST}));
/**
 * @brief 均值模糊滤波器测试套件
 */
INSTANTIATE_TEST_SUITE_P(PerformanceTestsMEANBLUR, cpuConv2dPerformanceTestFloat, testing::Values(PerformanceTestParams{512, 512, 10, 3, filter_type::MEANBLUR, mem_type::SHAREDCONST}, PerformanceTestParams{512, 512, 10, 5, filter_type::MEANBLUR, mem_type::SHAREDCONST}, PerformanceTestParams{1024, 1024, 10, 3, filter_type::MEANBLUR, mem_type::SHAREDCONST}, PerformanceTestParams{1024, 1024, 10, 5, filter_type::MEANBLUR, mem_type::SHAREDCONST}));
/**
 * @brief 拉普拉斯测试套件
 */
 ...
 * @brief 自定义内核测试套件
 */
INSTANTIATE_TEST_SUITE_P(PerformanceTestsFILTERCUSTOM, cpuConv2dPerformanceTestFloat, testing::Values(PerformanceTestParams{512, 512, 10, 3, filter_type::FILTERCUSTOM, mem_type::SHAREDCONST}, PerformanceTestParams{512, 512, 10, 5, filter_type::FILTERCUSTOM, mem_type::SHAREDCONST}, PerformanceTestParams{1024, 1024, 10, 3, filter_type::FILTERCUSTOM, mem_type::SHAREDCONST}, PerformanceTestParams{1024, 1024, 10, 5, filter_type::FILTERCUSTOM, mem_type::SHAREDCONST}));
...
TEST_P(cpuConv2dPerformanceTestFloat, PerformanceConv2d)
{
    ...
    // 输出详细性能报告
    std::cout << "\n========================================" << std::endl;
    std::cout << "     Performance Report (GPU SHATED)      " << std::endl;
    std::cout << "==========================================" << std::endl;
    ...
    std::cout << "memory type:      shared + contant\n";
    std::cout << "Result:          "
