 ...
 * @brief 高斯测试套件
 */
INSTANTIATE_TEST_SUITE_P(PerformanceTestsGAUSSIAN, cpuConv2dPerformanceTestFloat, testing::Values(PerformanceTestParams{512, 512, 10, 3, filter_type::GAUSSIAN}, PerformanceTestParams{512, 512, 10, 5, filter_type::GAUSSIAN}, PerformanceTestParams{1024, 1024, 10, 3, filter_type::GAUSSIAN}, PerformanceTestParams{1024, 1024, 10, 5, filter_type::GAUSSIAN}));
// /**
//  * @brief 锐化滤波器测试套件
//  */
// INSTANTIATE_TEST_SUITE_P(PerformanceTestsSHARPEN, cpuConv2dPerformanceTestFloat, testing::Values(PerformanceTestParams{512, 512, 10, 3, filter_type::SHARPEN}, PerformanceTestParams{512, 512, 10, 3, filter_type::SHARPEN}, PerformanceTestParams{1024, 1024, 10, 3, filter_type::SHARPEN}, PerformanceTestParams{1024, 1024, 10, 3, filter_type::SHARPEN}));
// /**
//  * @brief 均值模糊滤波器测试套件
//  */
// INSTANTIATE_TEST_SUITE_P(PerformanceTestsMEANBLUR, cpuConv2dPerformanceTestFloat, testing::Values(PerformanceTestParams{512, 512, 10, 3, filter_type::MEANBLUR}, PerformanceTestParams{512, 512, 10, 5, filter_type::MEANBLUR}, PerformanceTestParams{1024, 1024, 10, 3, filter_type::MEANBLUR}, PerformanceTestParams{1024, 1024, 10, 5, filter_type::MEANBLUR}));
// /**
//  * @brief 拉普拉斯测试套件
//  */
// INSTANTIATE_TEST_SUITE_P(PerformanceTestsLAPLACIAN, cpuConv2dPerformanceTestFloat, testing::Values(PerformanceTestParams{512, 512, 10, 3, filter_type::LAPLACIAN}, PerformanceTestParams{512, 512, 10, 3, filter_type::LAPLACIAN}, PerformanceTestParams{1024, 1024, 10, 3, filter_type::LAPLACIAN}, PerformanceTestParams{1024, 1024, 10, 3, filter_type::LAPLACIAN}));

// /**
//  * @brief 自定义内核测试套件
//  */
// INSTANTIATE_TEST_SUITE_P(PerformanceTestsFILTERCUSTOM, cpuConv2dPerformanceTestFloat, testing::Values(PerformanceTestParams{512, 512, 10, 3, filter_type::FILTERCUSTOM}, PerformanceTestParams{512, 512, 10, 5, filter_type::FILTERCUSTOM}, PerformanceTestParams{1024, 1024, 10, 3, filter_type::FILTERCUSTOM}, PerformanceTestParams{1024, 1024, 10, 5, filter_type::FILTERCUSTOM}));
...
TEST_P(cpuConv2dPerformanceTestFloat, PerformanceConv2d)
{
    ...
    {
        cpu_conv::gaussianBlur2D(input.data(), output.data(), params.width, params.height, params.ksize, 5.0);
    }
    else if (params.filter_type == filter_type::SOBEL)
    {
        cpu_conv::sobel(input.data(), output.data(), params.width, params.height);
    }
    else if (params.filter_type == filter_type::SHARPEN)
    {
        cpu_conv::sharpen(input.data(), output.data(), params.width, params.height);
    }
    else if (params.filter_type == filter_type::MEANBLUR)
    {
        cpu_conv::meanBlur(input.data(), output.data(), params.width, params.height, params.ksize);
    }
    else if (params.filter_type == filter_type::LAPLACIAN)
    {
        cpu_conv::laplacian(input.data(), output.data(), params.width, params.height);
    }
    else if (params.filter_type == filter_type::FILTERCUSTOM)
    {
        filter filterObj = filter::meanBlur(10);
        cpu_conv::conv2dKernel(input.data(), output.data(), params.width, params.height, filterObj);
    }
