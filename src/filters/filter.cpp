 ...
 * @return Kernel
 */
filter filter::gaussian2D(int size, float sigma)
{
 ...
 * @return Kernel
 */
filter filter::gaussian1D(int size, float sigma)
{
    filter k(size, std::vector<float>(size, 0.0f));
